...
def emptyNet():
    ...
    info( net[ 's02m1' ].cmd( 'python3 as07m1.py &amp' ) )
    info( net[ 's02m2' ].cmd( 'python3 as07m2.py &amp' ) )
    info( net[ 's02m3' ].cmd( 'python3 as07m3.py &amp' ) )
    info( net[ 's02m4' ].cmd( 'python3 as07m4.py &amp' ) )
    info( net[ 's02m5' ].cmd( 'python3 as07m5.py &amp' ) )
    info( net[ 's02m6' ].cmd( 'python3 as07m6.py &amp' ) )
    info( net[ 's02m7' ].cmd( 'python3 as07m7.py &amp' ) )
